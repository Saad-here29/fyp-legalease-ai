    ...
    def structured_analysis(
        ...
        *,
        ...
        prompt = (
            ...
            "Do NOT use AI self-references. The passage is statute text from "
            "LegalEase's library, which holds no court judgments: never cite "
            "case names, law-report citations (PLD, SCMR, MLD or similar) or "
            "any judgment, and cite only sections that appear in the passage.\n\n"
            "Issue: <the legal question or point of law>\n"
            "Findings: <what the statute provides on this point>\n"
            "Judgment: <the operative rule that emerges from the passage>\n"
            "Legal Basis: <the statute and sections in the passage it rests on>\n"
