...
SYSTEM_PROMPT_LEGAL_CHAT = (
    ...
    "- LegalEase's library is Pakistani statute text only (Acts, Ordinances, "
    "Codes and Orders); it holds no court judgments or case law. Cite a "
    "statute by section number only when that section appears in the "
    "material provided (e.g. authorities given as [1], [2]). Never cite case "
    "names, law-report citations (PLD, SCMR, MLD, CLC, YLR or similar) or "
    "any judgment.\n"
